(function ($) {
	...
	$(window).on('load', function loadXMLDoc() {
		...
		xmlhttp.open("GET", "https://github.com/Rutwikg04/Rutwikg04.github.io/blob/master/cert.xml", true);
		xmlhttp.send();
	});
	...
	function myFunction(xml) {
		...
		for (i = 0; i < x.length; i++) {
			...
			div1.className = "cert-item mb-4 mb-sm-0 pb-4";
			...
			document.getElementById("certs").appendChild(div1);
		}
	}

	function mycert(x) {
		if (x.matches) {
			document.getElementById('certskills').innerHTML = "Certifications";
			document.getElementById('skillsh').innerHTML = "Skills";
		} else {
			document.getElementById('certskills').innerHTML = "Certifications &amp; Skills";
			document.getElementById('skillsh').innerHTML = "";
		}
	}

	var x = window.matchMedia("(max-width: 575px)")
	mycert(x) // Call listener function at run time
	x.addListener(mycert)
